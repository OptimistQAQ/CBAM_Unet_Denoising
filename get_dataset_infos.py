...
def get_SID_info(info_dir='info', root_dir='/raid/qinjiahao/data/Sony', mode='train'):
...
def get_SID_info_from_txt(info_dir='infos', root_dir='/raid/qinjiahao/data/Sony', txt='SID_Sony_paired.txt'):
...
def get_ELD_info(info_dir='infos', root_dir='/raid/qinjiahao/data/ELD'):
    # oss path
...
class DatasetInfoParser():
    ...
    def parse(self):
        ...
        self.parser.add_argument('--root_dir', '-r', default="/raid/qinjiahao/data/Sony", type=str)
